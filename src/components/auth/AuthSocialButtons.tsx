...
// OAuth must be client-side because it redirects the browser.
// We use the browser supabase client here, NOT the server one.

import { useState } from "react";
import { createClient } from "@/lib/supabase/client";
import type { OAuthProvider } from "@/lib/supabase/authActions";
